...
const config: Config = {
  ...
  // Security
  CORS_ORIGINS: process.env.CORS_ORIGINS || 'https://foto-video-creative-suite.vercel.app,https://foto-video-creative-suite-hd6kzlmic-hafarnas-projects.vercel.app,http://localhost:5173,http://localhost:3000',
