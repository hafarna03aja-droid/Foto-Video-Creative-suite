...
const ApiKeyModal: React.FC<{
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-70 flex justify-center items-center z-50 p-4" onClick={onClose}>
      <div
        className="bg-gray-800 rounded-xl shadow-2xl w-full max-w-md p-6 space-y-4"
        onClick={(e) => e.stopPropagation()}
      >
        <h2 className="text-xl font-bold text-indigo-300">Atur Kunci API Gemini</h2>
        ...
        <div>
          ...
          />
           <p className="text-xs text-gray-500 mt-2">
            Dapatkan kunci API Anda dari <a href="https://aistudio.google.com/app/apikey" target="_blank" rel="noopener noreferrer" className="text-indigo-400 hover:underline">Google AI Studio</a>.
          </p>
        </div>
        {currentApiKey && (
            <p className="text-xs text-green-400">Kunci API yang ada telah disimpan.</p>
        )}
  ...
  return (
    <AuthWrapper>
      ...
      <main className="container mx-auto p-2 sm:p-4 md:p-6">
        <div className="mb-6 bg-gray-800/50 backdrop-blur-sm rounded-xl p-1 sm:p-2 max-w-max mx-auto">
        ...
        <div className="bg-gray-800 rounded-2xl shadow-2xl p-3 sm:p-6 md:p-8 min-h-[60vh]">
          {renderContent()}
        </div>
      </main>
