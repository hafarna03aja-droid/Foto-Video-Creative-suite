...
export const TextGeneration: React.FC<TextGenerationProps> = ({ onCreationComplete }) => {
  ...
  return (
    <div className="flex flex-col h-full">
      <h2 className="text-2xl font-bold mb-4 text-indigo-400">Pembuatan Teks</h2>
      <p className="text-gray-400 mb-6">Hasilkan teks untuk tugas apa pun. Gunakan "Mode Berpikir" dengan Gemini 2.5 Pro untuk tantangan paling kompleks Anda.</p>
        ...
        <div className="flex flex-wrap items-center justify-between gap-4">
           <div className="flex items-center gap-4">
            ...
            <select
                ...
                className="bg-gray-700 border border-gray-600 rounded-md px-3 py-2 focus:ring-2 focus:ring-indigo-500 focus:outline-none"
                disabled={isLoading}
            >
                {/* Fix: Use correct model name 'gemini-flash-lite-latest' per guidelines. */}
          ...
          <div className="flex items-center">
            ...
            <label 
              ...
              className={`ml-2 text-sm font-medium ${model !== 'gemini-2.5-pro' ? 'text-gray-500' : 'text-gray-300'}`}
            >
      ...
      {responseHtml && (
        <div className="mt-6 p-4 bg-gray-900/50 rounded-lg border border-gray-700 max-h-96 overflow-y-auto">
          <h3 className="font-semibold text-lg mb-2 text-indigo-300">Respons:</h3>
          <div 
