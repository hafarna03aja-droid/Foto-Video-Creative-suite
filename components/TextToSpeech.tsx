  ...
  return (
    <div className="flex flex-col md:flex-row h-full gap-8">
      ...
      <div className="flex-1 flex flex-col">
        <h2 className="text-2xl font-bold mb-4 text-indigo-400">Teks ke Suara</h2>
        <p className="text-gray-400 mb-6">Ubah teks menjadi ucapan yang terdengar alami, atau biarkan AI membuat narasi untuk kreasi visual terbaru Anda menggunakan Asisten Narasi.</p>
        ...
        <form onSubmit={handleSubmit} className="flex-grow flex flex-col gap-4">
          <textarea
            ...
            className="w-full flex-grow p-3 bg-gray-700 rounded-lg border border-gray-600 focus:ring-2 focus:ring-indigo-500 focus:outline-none resize-none"
            rows={8}
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            <div>
             ...
             <div>
              <label htmlFor="intonation-select" className="block text-sm font-medium text-gray-300 mb-2">
                Intonasi
              </label>
              <select
             ...
             <div>
              <label htmlFor="accent-select" className="block text-sm font-medium text-gray-300 mb-2">
                Logat
              </label>
              <select
                id="accent-select"
      ...
      <div className="md:w-2/5 lg:w-1/3 md:border-l md:border-gray-700 md:pl-8">
        <h3 className="text-xl font-bold mb-4 text-indigo-400">Asisten Narasi</h3>
        {isMediaCreation ? (
          <div className="space-y-3 p-4 bg-gray-900/50 rounded-lg border border-gray-700">
            <p className="text-sm font-semibold text-gray-300">Kreasi Terbaru Anda:</p>
            ...
            <p className="text-xs text-gray-400 italic truncate" title={lastCreation.prompt}>Prompt: {lastCreation.prompt}</p>
            <button
          ...
          <div className="text-center p-4 bg-gray-900/50 rounded-lg h-full flex items-center justify-center border border-gray-700">
